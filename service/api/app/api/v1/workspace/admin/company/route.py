...
from app.api.v1.workspace.admin.company import (
...
async def update(id: Annotated[UUID4, Path()], request: api_schema.CompanyRequestUpdate, auth_response: auth_dependency.DependAuthAdmin, db_async_session: db_dependency.DependDBAsyncSession):

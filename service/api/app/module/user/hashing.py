...
def get_password_hash(password_plain: str) -> str:
    return __pwd_context.hash(password_plain)


# verifying a password...
def verify_password_plain(password_plain: str, password_hash: str) -> bool:
    return __pwd_context.verify(password_plain, password_hash)
